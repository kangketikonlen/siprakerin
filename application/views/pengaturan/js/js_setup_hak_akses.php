<script>
	$(document).ready(function() {
		...
		// var optUrl = "<?= base_url('pengaturan/setup_hak_akses/options/') ?>";
		...
		// var tableUrl = "<?= base_url('pengaturan/setup_hak_akses/list_data?') ?>";
		...
		$('#Frm').submit(function(e) {
			e.preventDefault();
			var dataUrl = "<?= base_url('pengaturan/setup_hak_akses/simpan/') ?>";
		...
		$(document).on('click', '#edit', function() {
			var dataUrl = "<?= base_url('pengaturan/setup_hak_akses/get_data?') ?>";
		...
		$(document).on('click', '#hapus', function() {
			var dataUrl = "<?= base_url('pengaturan/setup_hak_akses/hapus?') ?>";
			var id = $(this).attr("data");
