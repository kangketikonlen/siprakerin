...
class Kelola_kehadiran_model extends CI_Model
{
	...
	public function get_list_data()
	{
		...
		$this->datatables->where($this->histori_kehadiran . '.biodata_prakerin_id', $this->session->userdata('id'));
	...
	{
		$this->db->where($this->histori_kehadiran . '.biodata_prakerin_id', $this->session->userdata('id'));
